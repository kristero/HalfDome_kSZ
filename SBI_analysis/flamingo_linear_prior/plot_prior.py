...
def legend_handles():
    return [Patch(facecolor=SAMPLE_COLOR, alpha=.55, label="Linear proposals + joint cuts"),
...
def make_figures(data, args):
    ...
    fig.suptitle("Broad linear prior and FLAMINGO fits", y=.995, fontsize=23)
    ...
    fig.text(.60, .91, "Broad linear prior and FLAMINGO fits", fontsize=29, ha="center")
...
def main():
    ...
    report = {"created_utc": datetime.now(timezone.utc).isoformat(),
              ...
              "marginal_histograms": "probability mass in equal-width physical bins; all nine proposal coordinates linear-uniform before cuts",
